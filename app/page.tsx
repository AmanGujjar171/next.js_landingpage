...
export default function main() {
  return (
    <div className="flex flex-col items-center">
      <Navbar />
      <div className=" border border-black h-[70vh] w-[100vw] bg-[#e4f5f4] ">
        <div className="border border-black flex flex-col items-center justify-evenly h-[50vh]  ">
          <h1 className="text-6xl w-[65vw] text-center font-semibold ">
            A powerful online engagement tool that’s intuitive and simple to
            use.
          </h1>
          <p className=" text-[#878787] w-[32vw] text-center text-lg ">
        ...
        <Image
          ...
          className=" ml-[20vw] flex justify-center items-center"
        />
      </div>
      <div className="flex flex-col items-center justify-around mt-[35vh] w-[100%] h-[30vh]     ">
        ...
        <div className=" w-[70vw] flex justify-around ">
          <Image src={Img2} alt="img2 does not show" />
          <Image src={Img3} alt="img2 does not show" />
          <Image src={Img4} alt="img2 does not show" />
          <Image src={Img5} alt="img2 does not show" />
          <Image src={Img6} alt="img2 does not show" />
          <Image src={Img7} alt="img2 does not show" />
        </div>
      ...
      <div className="w-[60vw] h-[50vh] flex justify-between items-center mt-[20vh]">
        <div className="h-[40vh] flex flex-col justify-around  ">
          ...
          <h1 className="text-2xl  ">Tool <span className="font-extrabold">Built for prople.</span></h1>
          <div className=" text-[#676767] h-[15vh] w-[21vw] flex flex-col justify-between ">
